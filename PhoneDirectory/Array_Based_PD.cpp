...
/** Remove an entry
	...
	*/
string Phone_Directory::remove_entry(const string& name) // Lindsey and Brandon both worked on this together in the lab
{

	int nameNUM = find(name);
	if (nameNUM != -1)
	{
		for (int i = nameNUM; i < size - 1; i++)
		{
